...
import {MapPin, Clock, Inbox, Building, CheckCircle2, XCircle} from 'lucide-react';
    ...
    return (
        <aside className={`lg:col-span-3 ${glassPane}`}>
            ...
            <div className="flex flex-col gap-3">
              ...
              ${lead.status !== 1 ? 'opacity-50 border-white/5 bg-transparent cursor-default' :
            ...
            `}
                    >
                        <div className="flex justify-between items-start mb-2">
                            <h3 className={`font-semibold ${lead.status !== 1 ? 'text-gray-500' : 'text-gray-100'} line-clamp-1`}>
                                {lead.role}
                            </h3>
                            {lead.status === 0 && (
